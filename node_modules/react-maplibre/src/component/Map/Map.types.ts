...
export interface MaplibreProps {
    ...
    onMapContextMenu?:(ev:MapMouseEvent,map:MaplibreMap)=>void,
    onMapDragStart?:(ev:MapLibreEvent<MouseEvent | TouchEvent | undefined>,map:MaplibreMap)=>void
    onMapDragEnd?:(ev:MapLibreEvent<MouseEvent | TouchEvent | undefined>,map:MaplibreMap)=>void
